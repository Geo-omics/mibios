# Generated by Django 3.2.19 on 2024-05-24 15:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', mibios.umrad.fields.PathField(max_length=200, path=pathlib.PurePosixPath('/geomicro/data2/kiledal/GLAMR/data/omics'), recursive=True, unique=True)),
                ('public', mibios.umrad.fields.PathField(blank=True, max_length=200, null=True, path=pathlib.PurePosixPath('/geomicro/data7/GLAMR-Website/public'), recursive=True)),
                ('filetype', models.PositiveSmallIntegerField(choices=[(1, 'metagenomic assembly, fasta format'), (2, 'metatranscriptome assembly, fasta format'), (3, 'functional abundance, csv format'), (4, 'taxonomic abundance, csv format')], verbose_name='file type')),
