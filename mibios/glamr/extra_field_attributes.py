...
extra_sample_field_attrs = {
    ...
    'tot_microcyst_lcmsms': {'verbose_name': 'Total microcystin', 'info_text': 'Total microcystin determined by LCMSMS', 'unit': 'μg/L'},
    ...
    'chlorophyll': {'verbose_name': 'Chlorophyll', 'unit': 'μg/L'},
    ...
    'chlorophyll_fluoresence': {'verbose_name': 'Chlorophyll a fluorescence', 'unit': 'rel AU'},
    'silicate': {'verbose_name': 'Silicate', 'unit': 'μmol/L'},
    ...
    'bluegreen': {'verbose_name': 'Bluegreen algae', 'unit': 'µg/L'},
    'diatoms': {'verbose_name': 'Diatoms', 'unit': 'µg/L'},
    'crypto': {'verbose_name': 'Cryptophyta', 'unit': 'µg/L'},
    'sortchem': {},
    ...
    'amended_site_name': {'verbose_name': 'Amended site name', 'info_text': 'Amended sampling location name if not the same as the original site name'},
    'salinity': {'verbose_name': 'Salinity measured using a sonde', 'unit': 'ppt', 'pseudo_unit': 'parts per thousand'},
    'atmospheric_temp': {'verbose_name': 'atmospheric temperature', 'unit': '°C'},
    'particulate_cyl': {'verbose_name': 'particulate cylindrospermopsin', 'info_text': 'particulate cylindrospermopsin measured via ELISA', 'unit': 'ng/mL'},
    'station_description': {'verbose_name': 'station description about location'},
    'replicate_id': {'verbose_name': 'replicate ID', 'info_text': 'replicate ID if metagenomic samples sequenced in replicate'},
    'orp': {'verbose_name': 'Redox potential-ORP', 'unit': 'mV', 'pseudo_unit': 'millivolts'},
